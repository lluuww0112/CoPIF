...
def main(config: DictConfig) -> None:
    ...
    dataset = str(invoke_config.get("dataset", train_config.get("dataset", "refcoco")))
    splitby = str(invoke_config.get("splitby", train_config.get("splitby", "unc")))
    split = str(invoke_config.get("split", "val"))
    requested_device = str(invoke_config.get("device", train_config.get("device", "cuda")))
    ...
    checkpoint_dir = _resolve_project_path(
        str(invoke_config.get("checkpoint_dir", train_config.get("checkpoint_dir", "history/comparison")))
    )
